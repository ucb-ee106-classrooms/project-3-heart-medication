...
<<<<<<< HEAD
    ...
    # State constraints
    constraints.extend([q_lb[0] <= q[0, :], q[0, :] <= q_ub[0]]) # x
    constraints.extend([q_lb[1] <= q[1, :], q[1, :] <= q_ub[1]]) # y
    constraints.extend([q_lb[2] <= q[2, :], q[2, :] <= q_ub[2]]) # theta
    constraints.extend([q_lb[3] <= q[3, :], q[3, :] <= q_ub[3]]) # pheeee
...
<<<<<<< HEAD
            ...
            constraints.append(euclidean_distance>=(obj_r)**2)
