...
struct RobotMsg_
{
  ...
  _footprint_type footprint;
   ...
   typedef std::vector< ::stdr_msgs::LaserSensorMsg_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::stdr_msgs::LaserSensorMsg_<ContainerAllocator> >> _laserSensors_type;
  _laserSensors_type laserSensors;

   typedef std::vector< ::stdr_msgs::SonarSensorMsg_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::stdr_msgs::SonarSensorMsg_<ContainerAllocator> >> _sonarSensors_type;
  _sonarSensors_type sonarSensors;

   typedef std::vector< ::stdr_msgs::RfidSensorMsg_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::stdr_msgs::RfidSensorMsg_<ContainerAllocator> >> _rfidSensors_type;
  _rfidSensors_type rfidSensors;

   typedef std::vector< ::stdr_msgs::CO2SensorMsg_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::stdr_msgs::CO2SensorMsg_<ContainerAllocator> >> _co2Sensors_type;
  _co2Sensors_type co2Sensors;

   typedef std::vector< ::stdr_msgs::SoundSensorMsg_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::stdr_msgs::SoundSensorMsg_<ContainerAllocator> >> _soundSensors_type;
  _soundSensors_type soundSensors;

   typedef std::vector< ::stdr_msgs::ThermalSensorMsg_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::stdr_msgs::ThermalSensorMsg_<ContainerAllocator> >> _thermalSensors_type;
