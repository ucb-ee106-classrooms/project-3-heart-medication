...
struct RegisterGuiResponse_
{
  ...
  (void)_alloc;
   ...
   typedef std::vector< ::stdr_msgs::RobotIndexedMsg_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::stdr_msgs::RobotIndexedMsg_<ContainerAllocator> >> _robots_type;
  _robots_type robots;
