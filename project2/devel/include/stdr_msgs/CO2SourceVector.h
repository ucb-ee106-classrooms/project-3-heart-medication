...
struct CO2SourceVector_
{
  ...
  (void)_alloc;
   ...
   typedef std::vector< ::stdr_msgs::CO2Source_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::stdr_msgs::CO2Source_<ContainerAllocator> >> _co2_sources_type;
